              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text( tempList[0].subTotal! + " "  + CUR_CURRENCY,
                        style: Theme.of(context)
                            .textTheme
                            .button!
                            .copyWith(color: lightBlack2))
                  ...
                  children: [
                    Text(getTranslated(context, "DELIVERY_CHARGE")! + " " + ":",
                        style: Theme.of(context)
                            ...
                            .button!
                            .copyWith(color: lightBlack2)),
                    Text("+ "  + tempList[0].delCharge! + " " + CUR_CURRENCY,
                        style: Theme.of(context)
                            .textTheme
                            .button!
                            .copyWith(color: lightBlack2))
                  ...
                  children: [
                    Text(
                        ...
                        style: Theme.of(context)
                            ...
                            .button!
                            .copyWith(color: lightBlack2)),
                    Text("+ " +  tempList[0].taxAmt! + " "  + CUR_CURRENCY ,
                        style: Theme.of(context)
                            .textTheme
                            .button!
                            .copyWith(color: lightBlack2))
                  ...
                  children: [
                    Text(
                        ...
                        style: Theme.of(context)
                            ...
                            .copyWith(color: lightBlack2)),
                    Text(
                      "- "  + tempList[0].promoDis! + CUR_CURRENCY + " ",
                  ...
                  children: [
                    Text(getTranslated(context, "WALLET_BAL")! + " " + ":",
                        style: Theme.of(context)
                            ...
                            .button!
                            .copyWith(color: lightBlack2)),
                    Text("- " + tempList[0].walBal! + CUR_CURRENCY + " ",
                        style: Theme.of(context)
                            .textTheme
                            .button!
                            .copyWith(color: lightBlack2))
                ...
                child: Row(
                  ...
                  children: [
                    Text(getTranslated(context, "PAYABLE")! + " " + ":",
                        style: Theme.of(context).textTheme.button!.copyWith(
                            color: lightBlack, fontWeight: FontWeight.bold)),
                    Text( tempList[0].payable! + CUR_CURRENCY + " ",
                        style: Theme.of(context).textTheme.button!.copyWith(
                            color: lightBlack, fontWeight: FontWeight.bold))
                  ],
                ),
